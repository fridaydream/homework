...
var PraiseThumb = function () {
    function PraiseThumb(num, ele) {
        _classCallCheck(this, PraiseThumb);

        this.num = num;
        this.ele = ele;
    }

    _createClass(PraiseThumb, [{
        key: 'clickAction',
...
var Thumb = function (_PraiseThumb) {
    _inherits(Thumb, _PraiseThumb);
